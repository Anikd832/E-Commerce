...
@section('content')
        <!--product detail main body - start
        ================================================== -->
        <main>
                    ...
                    <div class="details_information_tab">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="additional_information_tab" role="tabpanel">
                                {{-- <p> {{$product->product_additional_information}}</p> --}}
                                <p> {!! $product->product_additional_information !!}</p>
                                    ...
                                    @foreach ($related_products as $product )
                                        <div class="grid">
                                            ...
                                            <div class="details">
                                                ...
                                                <p><a href="{{url('product/details')}}/{{$product->id}}">{{Str::limit($product->product_short_description)}} </a></p>
                                                <div class="rating">
                                                ...
                                                <span class="price">
                                                    <ins>
                                                        <span class="woocommerce-Price-amount amount">
                                                            <bdi>
                                                                <span class="woocommerce-Price-currencySymbol">৳</span>{{$product->product_discounted_price}}
                                                            </bdi>
                                                        </span>
                                                    </ins>
                                                        @if ($product->product_regular_price > $product->product_discounted_price)
