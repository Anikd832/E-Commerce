    ...
    ***********************************-->
    <div id="main-wrapper">
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('dashboard_assets')}}/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('dashboard_assets')}}/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('dashboard_assets')}}/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('dashboard_assets')}}/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('dashboard_assets')}}/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{asset('dashboard_assets')}}/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="{{asset('dashboard_assets')}}/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="{{asset('dashboard_assets')}}/images/avatar/1.jpg">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="{{asset('uploads/profile_photos')}}/{{auth()->user()->profile_photo}}" width="20" alt="not found"/>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{url('profile')}}" class="ai-icon" aria-expanded="false">
						<i class="fa fa-user-o"></i>
						<span class="nav-text">Profile</span>
					    </a>
					</li>
                    <li><a href="{{url('messages')}}" class="ai-icon" aria-expanded="false">
                    ...
                    <li><a href="{{url('category/index')}}" class="ai-icon" aria-expanded="false">
						<i class="fa fa-th"></i>
						<span class="nav-text">Category</span>
					    </a>
					</li>
                    <li><a href="{{url('product/index')}}" class="ai-icon" aria-expanded="false">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="./ui-accordion.html">Reserved</a></li>
						</ul>
					</li>
                </ul>

				<div class="copyright">
					<p><strong>{{env('APP_NAME')}} Admin Dashboard</strong> © {{date('Y')}} All Rights Reserved</p>
					<p>Made with <span class="heart"></span> {{date('Y')}}</p>
				</div>
			</div>
        </div>
        <!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">Anik Kumar Das</a> {{date('Y')}}</p>
            </div>
        </div>
        <!--**********************************
            Footer end
